Point(1) = {0.004, -0.004, 0, 1.0};
Point(2) = {-0.004, -0.004, 0, 1.0};
Point(3) = {0.0004, -0.004, 0, 1.0};
Point(4) = {-0.0004, -0.004, 0, 1.0};

Point(8) = {0.00040, -0.0004, 0, 1.0};
Point(9) = {0.00040, 0.00040, 0, 1.0};
Point(10) = {-0.00040, 0.00040, 0, 1.0};
Point(11) = {-0.00040, -0.0004, 0, 1.0};

Point(13) = {0.004, -0.0004, 0, 1.0};
Point(14) = {0.004, 0.004, 0, 1.0};
Point(15) = {-0.004, 0.004, 0, 1.0};
Point(16) = {-0.004, -0.0004, 0, 1.0};
...
//+
Transfinite Curve {11, 9, 7, 1, 10, 4, 19, 24} = 9 Using Progression 1;
//+
Transfinite Curve {2, 3, 13, 12, 14, 15, 5, 6, 16, 8, 17, 18, 20, 21, 22, 23} = 37 Using Progression 1;
