...
def main():
  ...
  required_files = {
      ...
      "../tests/test-8_LogCircular-1-100-fluxGO/results/config-21/convergence_results.csv": {
          "command": "mpirun -np {n} ./ion-propulsion ../tests/test-8_LogCircular-1-100-fluxGO/config-21-MappingQ2-FlatManif-only_concentric.yaml",
          "threshold": 3e5
      },
      ...
      #    "threshold": 6e5
      #},
      # NOTE: The Kelly Error Estiamtor is not available in the current branch. Use SERIAL code for that.
